...
export function HandWrittenTitle({ title = "Hand Written", subtitle = "Optional subtitle" }: HandWrittenTitleProps) {
  const draw = {
      ...
      <div className="absolute inset-0">
        ...
        >
          ...
          <motion.path
            ...
            variants={draw}
            className="text-primary dark:text-primary opacity-90"
          />
        </motion.svg>
      </div>
